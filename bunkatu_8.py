...
"""
#add
patch_size_t = 256*2//3
stride = 10
patch_size_v = 256*2//3
stride_v = 10
...
patch_v = tf.extract_image_patches(test_x_batch, ksizes=[1, patch_size_v, patch_size_v, 1], strides=[1,stride_v, stride_v, 1], rates=[1, 1, 1, 1], padding='VALID')
