...
with tf.name_scope('LoadImage'):
	...
	_, label, path, _, _ = tf.decode_csv(val, record_defaults=record_defaults)
	...
	label_batch, x_batch = tf.train.batch([label, images],batch_size=a.batch_size, allow_smaller_final_batch=False)
